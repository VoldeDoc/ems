...
import herobg1 from "../assets/nanny.png";
...
const curriculumData = [
  "Introduction to Professional Childcare",
  "Educational Plan and Early Learning",
  "Cultural Sensitivity and Household Management",
  "Safety, Emergency Preparedness and First Aid",
];

const targetAudience = [
  "Aspiring nannies and early childcare providers",
  "Current domestic staff who care for children",
  "Anyone looking to enter professional childcare in private homes",
];
      ...
      <div className=" lg:px-15 md:px-10 px-5 p inter  pb-30 inter justify-between bg-white w-full">
        ...
        <div className="lg:px-15 md:px-18 px-3">
          <div className="md:flex md:space-x-5" id="Overview">
            ...
            <div className="flex-1 space-y-6 lg:w-1/2">
              ...
              <p className="text-[#333333] font-medium text-base md:text-xl">
                Have you ever met a nanny who:
              </p>
              <ul className="list-disc list-inside text-[#333333]  text-[12px] md:text-base space-y-2">
                <li>
                  Connects with children instantly, gaining their trust and
                  affection
                </li>
                <li>
                  Supports learning and development in a structured, nurturing
                  way
                </li>
                <li>
                  Balances household responsibilities with childcare
                  effortlessly
                </li>
              </ul>
              <section className="space-y-4 mt-6">
                ...
                <p className="text-[#333333] text-[12px] md:text-base inter leading-relaxed">
                  Professional nannies are more than caretakers, they are
                  educators, protectors, and trusted members of a household.
                  This Nanny Training Course is designed to equip participants
                  with practical skills and professional standards tailored to
                  high-net-worth homes and culturally diverse families in
                  Nigeria. Whether you’re starting out or enhancing your career
                  in childcare, this course will prepare you to work confidently
                  and competently in any household setting.
                </p>
              </section>
            </div>
          ...
          <section className="bg-[#E1F7E366] px-8 py-10 my-10">
            <h2 className="text-2xl md:text-[30px] text-[#333333] font-semibold mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                "Deliver quality childcare with professionalism and empathy",
                "Navigate cultural and religious dynamics within families",
                "Support early childhood learning and structured play",
                "Maintain household order while prioritising child safety",
                "Respond to emergencies with calm and competence",
              ].map((outcome) => (
          ...
          <section className="space-y-2 mb-10" id="Entry-Requirements">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                ...
                <li>Experience with children is an advantage</li>
                <li>
                  A respectful, compassionate attitude and willingness to learn
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                ...
                <li>Video Content</li>
                <li>Worksheets and Childcare Simulations</li>
              </ul>
            </div>
          </section>
