...
import herobg1 from "../assets/header6.png";
...
const targetAudience = [
  "Individuals working in multicultural or international settings",
  "Domestic staff serving clients or guests from diverse backgrounds",
  "Anyone interested in enhancing their cultural awareness and sensitivity",
];
        ...
        <div className="lg:px-15 md:px-18 px-3">
          <div className="md:flex md:space-x-5" id="Overview">
            ...
            <div className="flex-1 space-y-6 lg:w-1/2">
              ...
              <p className="text-[#333333] font-medium text-base md:text-xl">
                Have you ever worked in a diverse environment where:
              </p>
              <ul className="list-disc list-inside text-[#333333] text-[12px] md:text-base space-y-2">
                <li>
                  Respect and understanding for different cultures were the norm
                </li>
                <li>
                  Interactions flowed smoothly, with no misunderstandings or
                  offence
                </li>
                <li>
                  Diversity was celebrated and incorporated into daily practices
                </li>
              </ul>
              ...
              <section className="space-y-4 mt-6">
                ...
                <p className="text-[#333333] text-[12px] md:text-base inter leading-relaxed">
                  Cultural Competence and Awareness are vital in today’s
                  globalised world. Whether you're working with international
                  clients, managing a diverse team, or hosting guests from
                  various backgrounds, understanding and respecting cultural
                  differences can create stronger, more inclusive relationships.
                  This course equips participants with the tools and strategies
                  to engage respectfully and effectively in multicultural
                  settings, promoting a welcoming and inclusive environment.
                </p>
              </section>
            </div>
          ...
          <section className="bg-[#E1F7E366] px-8 py-10 my-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                "Respect and appreciate different cultural beliefs and traditions",
                "Avoid common cultural assumptions and stereotypes",
                "Communicate effectively with people from diverse cultural backgrounds",
                "Foster a welcoming and inclusive environment at home and in the workplace",
              ].map((outcome) => (
          ...
          <section className="space-y-2 mb-10" id="Entry-Requirements">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                ...
                <li>
                  Open-mindedness and willingness to learn about different
                  cultures
                </li>
                <li>
                  Desire to promote inclusivity and respect in all interactions
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            <div>
              ...
              <p className="text-sm md:base inter font-medium text-[#1D2026] mb-4">
                This one-week on-site course includes:
              </p>
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                <li> Group discussions and case study analysis</li>
                <li>Video lessons and real-world cultural scenarios</li>
                <li>Practical activities to build respectful communication</li>
                <li>Role-plays and cultural sensitivity exercises</li>
              </ul>
            </div>
          </section>
