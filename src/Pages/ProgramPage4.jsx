...
import herobg1 from "../assets/sliver.jpg";
...
const curriculumData = [
  "Key Principles of Silver Service",
...
const targetAudience = [
  "Stewards and butlers seeking to refine their table service skills",
  "Housekeepers and cooks supporting formal events",
  "Event staff and domestic workers in high-end homes",
];
        ...
        <div className="lg:px-15 md:px-18 px-3">
          <div className="md:flex md:space-x-5" id="Overview">
            ...
            <div className="flex-1 space-y-6 lg:w-1/2">
              ...
              <ul className="list-disc list-inside text-[#333333] text-[12px] md:text-base space-y-2">
                <li>Every plate, glass, and napkin is perfectly placed</li>
                <li>Service flows smoothly, silently, and professionally</li>
                <li>Every guest feels seen, respected, and well-attended</li>
              </ul>
              ...
              <section className="space-y-4 mt-6">
                ...
                <p className="text-[#333333] text-[12px] md:text-base inter leading-relaxed">
                  Silver Service is the gold standard in formal dining—precise,
                  elegant, and refined. This course offers intensive training in
                  the art of table setting, food and drink service, and guest
                  interaction for private homes, luxury shortlets, and formal
                  events. Whether you’re a steward, housekeeper, chef, or
                  aspiring butler, this focused course gives you the etiquette
                  and technical skills to deliver exceptional service.
                </p>
              </section>
            </div>
          ...
          <section className="bg-[#E1F7E366] px-8 py-10 my-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                "Understand and apply the core principles of Silver Service",
                "Set tables to international fine dining standards",
                "Serve meals and beverages with grace and efficiency",
                "Engage with guests professionally and confidently",
              ].map((outcome) => (
          ...
          <section className="space-y-2 mb-10" id="Entry-Requirements">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                ...
                <li>Attention to detail and personal discipline</li>
                <li>Willingness to learn and apply formal etiquette</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            <div>
              ...
              <p className="text-sm md:base inter font-medium text-[#1D2026] mb-4">
                This is a hand on fully on-site course featuring:
              </p>
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                <li>Live Table Setting Demonstrations</li>
                <li>Guided Meal Service Simulations</li>
                <li>Etiquette and Guest Engagement Role-Plays</li>
                <li>Worksheets and Presentation Drills</li>
              </ul>
            </div>
          </section>
