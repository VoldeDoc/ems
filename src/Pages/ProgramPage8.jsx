...
import herobg1 from "../assets/luxury.jpg";
...
const curriculumData = [
  "The Philosophy of Luxury Bedding and Guest Comfort",
  "Mastering the Art of Impeccable Bed Making",
  "Selecting and Caring for Luxury Linens and Bedding",
  "The Nuances of Pillow Selection and Arrangement",
  "Crafting the Perfect Turn-Down Service: Beyond the Basics",
  "Personalizing the Bed and Turn-Down Experience",
  "Efficiency and Time Management in Luxury Bed Services",
  "Hygiene and Presentation Standards",
  "Practical Application and Mock Service",
];

const targetAudience = [
  "Housekeeping staff in luxury hotels, resorts, and private residences",
  "Individuals seeking to enter the high-end hospitality sector.",
  "Anyone looking to enhance their skills in providing exceptional guest comfort and service.",
];
...
const ProgramPage8 = () => {
  ...
  return (
    <div className="max-w-[1500px] mx-auto">
      <Header2 />
      <div className=" lg:px-15 md:px-10 px-5 p  pb-30 inter justify-between bg-white w-full">
        ...
        <div className="lg:px-15 md:px-18 px-3">
          <div className="md:flex md:space-x-5" id="Overview">
            ...
            <div className="flex-1 space-y-6 lg:w-1/2">
              ...
              <p className="text-[#333333] font-medium text-base md:text-xl">
                Imagine a setting where every detail speaks of unparalleled
                comfort and meticulous care:
              </p>
              <ul className="list-disc list-inside text-[#333333] text-[12px] md:text-base space-y-2">
                <li>
                  Beds that invite restful sleep with their flawless
                  presentation.
                </li>
                <li>
                  Guest rooms that anticipate every need, creating a sense of
                  personalized luxury.
                </li>
                <li>
                  Service that goes beyond the expected, leaving a lasting
                  impression of indulgence.
                </li>
              </ul>
              ...
              <section className="space-y-4 mt-6">
                ...
                <p className="text-[#333333] text-[12px] md:text-base inter leading-relaxed">
                  In the realm of high-end hospitality, the art of luxury bed
                  making and turn-down services is paramount. This skill
                  transforms a simple room into a sanctuary of comfort and
                  elevates the guest experience to exceptional levels. This
                  intensive course provides participants with the comprehensive
                  knowledge and practical techniques to master these essential
                  aspects of luxury service, ensuring a welcoming and
                  unforgettable stay for discerning guests.
                </p>
              </section>
            </div>
            ...
            <div className="lg:w-1/2 flex justify-center inter md:justify-end">
              <aside className="mt-12 lg:mt-0 lg:w-80 bg-[#c5ac8e] inter h-fit text-white p-6 rounded-lg">
                ...
                <div className="flex justify-between mb-3">
                  ...
                  <p className="inter font-semibold w-[91px]">₦300,000</p>
                </div>
                ...
                <div className="mb-6">
                  <div className="flex justify-between items-center w-full space-x-2">
                    ...
                    <p className="text-lg font-bold inter w-[91px]">₦350,000</p>
                  </div>
                </div>
                <NavLink to="/enroll">
          ...
          <section className="bg-[#E1F7E366] px-8 py-10 my-10">
            ...
            <h2 className="text-base md:text-xl text-[#333333] font-medium mb-6">
              By the end of the training, participants will be able to:
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                "Understand and articulate the principles behind luxury bedding and guest comfort.",
                "Execute flawless bed-making techniques to achieve impeccable standards",
                "Identify, select, and properly care for high-quality linens and bedding materials",
                "Master the art of selecting and arranging pillows for optimal comfort and aesthetics",
                "Perform sophisticated turn-down services that go beyond basic tidying.",
                "Personalize the bed and turn-down experience to cater to individual guest preferences",
                "Implement efficient and time-saving strategies in luxury bed services.",
                "Maintain the highest standards of hygiene and presentation",
                "Confidently apply learned techniques in practical service scenarios.",
              ].map((outcome) => (
          ...
          <section className="space-y-2 mb-10" id="Entry-Requirements">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                ...
                <li>Attention to detail and a commitment to excellence.</li>
                <li>
                  A desire to provide the highest level of guest satisfaction.
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            <div>
              ...
              <p className="text-sm md:base inter font-medium text-[#1D2026] mb-4">
                This 1-week course is held on-site and includes:
              </p>
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                <li>
                  Hands-on practice and demonstrations of luxury bed-making
                  techniques.
                </li>
                <li>
                  Interactive sessions on linen selection, care, and pillow
                  arrangement
                </li>
                <li>
                  Role-playing exercises for delivering personalized turn-down
                  services.
                </li>
                <li>
                  Case study analysis of guest preferences and service
                  scenarios.
                </li>
                <li>Practical application and mock service assessments.</li>
              </ul>
            </div>
          </section>
