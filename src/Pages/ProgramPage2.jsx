...
import herobg1 from "../assets/header5.png";
...
const curriculumData = [
  ...
  "Why Social Etiquette is Important",
  "Basic Social Etiquette Practical Sessions",
];

const targetAudience = [
  "Individuals looking to improve their social presence and interactions",
  "Those preparing for professional networking or public events",
  "Anyone interested in gaining confidence in social settings",
];
        ...
        <div className="lg:px-15 md:px-18 px-3">
          <div className="md:flex md:space-x-5" id="Overview">
            ...
            <div className="flex-1 space-y-6 lg:w-1/2">
              ...
              <p className="text-[#333333] font-medium text-base md:text-xl">
                Have you ever observed individuals who:
              </p>
              <ul className="list-disc list-inside text-[#333333]  text-[12px] md:text-base space-y-2">
                <li>Move through social settings with confidence and grace</li>
                <li>
                  Know exactly how to engage in conversations, introductions,
                  and situations
                </li>
                <li>Leave a lasting positive impression, effortlessly</li>
              </ul>
              <section className="space-y-4 mt-6">
                ...
                <p className="text-[#333333] text-[12px] md:text-base inter leading-relaxed">
                  Social Etiquette is more than just manners, it’s about
                  presenting yourself in the best possible light while
                  respecting the norms and expectations of any social
                  environment. This course equips participants with the
                  essential skills and understanding to navigate a variety of
                  social situations, whether at events, in professional
                  settings, or in private circles. Through practical learning
                  and role-playing, you’ll develop the skills necessary to
                  present yourself as polished, respectful, and poised
                </p>
              </section>
            </div>
          ...
          <section className="bg-[#E1F7E366] px-8 py-10 my-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                "Understand the key principles of social etiquette",
                "Navigate both formal and informal social interactions with confidence",
                "Apply basic social etiquette in various settings, from parties to professional engagements",
              ].map((outcome) => (
          ...
          <section className="space-y-2 mb-10" id="Entry-Requirements">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                ...
                <li>
                  Interest in improving personal presentation and social
                  interactions
                </li>
                <li>
                  Willingness to engage in role-plays and practical scenarios
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                <li> Live Social Etiquette Demonstrations</li>
                <li>Interactive Role-Plays</li>
                <li>Video Lessons and Discussions</li>
                <li>Etiquette Worksheets and Exercises</li>
              </ul>
            </div>
          </section>
