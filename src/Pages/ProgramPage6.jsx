...
import herobg1 from "../assets/header.png";
...
const curriculumData = [
  "Formal Table Service & Beverage Knowledge",
  "Event Planning & Private Functions",
  "Guest Relations & Concierge Services",
  "Safety, Emergency Preparedness and First Aid",
];

const targetAudience = [
  "Aspiring butlers and personal service professionals",
  "Experienced domestic staff aiming to upskill",
  "Those interested in high-level hospitality roles in private households",
];
        ...
        <div className="lg:px-15 md:px-18 px-3">
          <div className="md:flex md:space-x-5" id="Overview">
            ...
            <div className="flex-1 space-y-6 lg:w-1/2">
              ...
              <p className="text-[#333333] font-medium text-base md:text-xl">
                Have you ever experienced a residence or event where:
              </p>
              <ul className="list-disc list-inside text-[#333333] text-[12px] md:text-base space-y-2">
                <li>Service is discreet, flawless, and intuitive</li>
                <li>
                  Guests feel welcomed, cared for, and impressed without effort
                </li>
                <li>Every moment is managed with elegance and precision</li>
              </ul>
              ...
              <section className="space-y-4 mt-6">
                ...
                <p className="text-[#333333] text-[12px] md:text-base inter leading-relaxed">
                  The butler is the gold standard in private household
                  service—an ambassador of excellence. This course equips
                  aspiring and practising butlers with the skills, knowledge,
                  and professional demeanour to thrive in elite homes and formal
                  environments. From fine dining and beverage service to event
                  coordination and guest relations, this training covers every
                  essential aspect of modern butlering, tailored for luxury
                  homes in Nigeria and beyond.
                </p>
              </section>
            </div>
              ...
              <aside className="mt-12 lg:mt-0 lg:w-80 bg-[#c5ac8e] inter h-fit text-white p-6 rounded-lg">
                ...
                <div className="mb-6">
                  <div className="flex justify-between items-center w-full space-x-2">
                    ...
                    <p className="text-lg font-bold inter w-[91px]">₦600,000</p>
                  </div>
                </div>
                <NavLink to="/enroll">
          ...
          <section className="bg-[#E1F7E366] px-8 py-10 my-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                "Serve as professional butlers with poise and discretion",
                "Deliver formal table service and manage beverage presentation",
                "Coordinate private events and special functions seamlessly",
                "Provide high-level guest and concierge services",
                "Maintain a safe, organised, and secure household environment",
              ].map((outcome) => (
          ...
          <section className="space-y-2 mb-10" id="Entry-Requirements">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                ...
                <li>Professional appearance and attention to detail</li>
                <li>
                  Willingness to serve with discretion, courtesy, and care
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            <div>
              ...
              <p className="text-sm md:base inter font-medium text-[#1D2026] mb-4">
                The training is delivered fully on-site and includes:
              </p>
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                <li>Live Demonstrations of Table & Beverage Service</li>
                <li>Role-Playing and Etiquette Drills</li>
                <li>Video Lessons and Hospitality Simulations</li>
                <li>Event Planning Exercises and Practical Guest Management</li>
              </ul>
            </div>
          </section>
