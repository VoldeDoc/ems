...
import herobg1 from "../assets/steward.jpg";
...
const curriculumData = [
  "Introduction to Professional Stewardship",
  "Wardrobe Management and Personal Assistance",
  "Cultural Competence and Etiquette",
  "Safety, Emergency Preparedness and First Aid",
];

const targetAudience = [
  "Personal stewards and assistants in private homes",
  "Domestic staff transitioning into personal service roles",
  "Anyone aspiring to work in high-end household service",
];
        ...
        <div className="lg:px-15 md:px-18 px-3">
          <div className="md:flex md:space-x-5" id="Overview">
            ...
            <div className="flex-1 space-y-6 lg:w-1/2">
              ...
              <p className="text-[#333333] font-medium text-base md:text-xl">
                Have you ever observed a household where
              </p>
              <ul className="list-disc list-inside text-[#333333]  text-[12px] md:text-base space-y-2">
                <li>Staff anticipate needs before they are expressed</li>
                <li>
                  Wardrobe, personal errands, and guest services are handled
                  with precision
                </li>
                <li>
                  Every interaction reflects poise, professionalism, and
              ...
              <section className="space-y-4 mt-6">
                ...
                <p className="text-[#333333] text-[12px] md:text-base inter leading-relaxed">
                  A professional steward is the silent engine behind seamless
                  personal service in high-end homes. This training is designed
                  to equip stewards with the confidence, competence, and
                  cultural sensitivity needed to deliver world-class support in
                  personal assistance, wardrobe care, and household etiquette.
                  Whether you're entering the field or enhancing your skills,
                  this course prepares you to serve with distinction and
                  discretion.
                </p>
              </section>
            </div>
          ...
          <section className="bg-[#E1F7E366] px-8 py-10 my-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                "Provide high-quality personal assistance with professionalism and tact",
                "Manage wardrobe care, packing, and presentation with attention to detail",
                "Interact with principals, guests, and colleagues with cultural awareness and etiquette",
                "Ensure safety and respond effectively in emergencies",
              ].map((outcome) => (
          ...
          <section className="space-y-2 mb-10" id="Entry-Requirements">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                ...
                <li>A respectful, discreet, and service-oriented attitude</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                ...
                <li>Video Content and Guided Discussions</li>
                <li>Worksheets and Personal Service Simulations</li>
              </ul>
            </div>
          </section>
