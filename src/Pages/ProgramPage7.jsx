...
import herobg1 from "../assets/header3.png";
...
const curriculumData = [
  "Understanding Nigerian Household Management",
...
const targetAudience = [
  "Aspiring and current House Managers",
  "Senior domestic staff looking to take on leadership roles",
  "Anyone managing operations in a high-end private home",
];
        ...
        <div className="lg:px-15 md:px-18 px-3">
          <div className="md:flex md:space-x-5" id="Overview">
            ...
            <div className="flex-1 space-y-6 lg:w-1/2">
              ...
              <p className="text-[#333333] font-medium text-base md:text-xl">
                Have you ever seen a household where:
              </p>
              <ul className="list-disc list-inside text-[#333333] text-[12px] md:text-base space-y-2">
                <li>Operations run like a well-oiled machine</li>
                <li>Staff work harmoniously under clear leadership</li>
                <li>
                  Every resource is tracked, accounted for, and well-maintained
                </li>
              </ul>
              ...
              <section className="space-y-4 mt-6">
                ...
                <p className="text-[#333333] text-[12px] md:text-base inter leading-relaxed">
                  A professional House Manager is the central figure in managing
                  the day-to-day operations of private residences, especially
                  those of high-net-worth individuals. This course prepares
                  participants to take full ownership of household
                  administration, staff coordination, budgeting, and emergency
                  response. Whether stepping into this leadership role or
                  seeking to refine your management approach, this training will
                  equip you with the confidence, systems, and standards required
                  for success.
                </p>
              </section>
            </div>
          ...
          <section className="bg-[#E1F7E366] px-8 py-10 my-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                "Understand the structure and culture of Nigerian high-standard households",
                "Manage finances, supplies, and inventories with accuracy",
                "Supervise staff effectively and resolve conflicts professionally",
                "Ensure safety and emergency readiness within the home",
              ].map((outcome) => (
          ...
          <section className="space-y-2 mb-10" id="Entry-Requirements">
            <div>
              ...
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                <li>
                  {" "}
                  Secondary School Leaving Certificate (tertiary education is an
                  added advantage)
                </li>
                <li>Strong communication and organisational skills</li>
                <li>Fluency in English</li>
                <li>A leadership mindset with a service-driven attitude</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            <div>
              ...
              <p className="text-sm md:base inter font-medium text-[#1D2026] mb-4">
                This intensive, fully on-site course includes:
              </p>
              <ul className="list-disc list-inside text-[#4E5566] text-sm md:text-base inter space-y-1">
                <li>Practical Management Scenarios</li>
                <li>Staff Coordination Role-Plays</li>
                <li>Financial Tracking Exercises</li>
                <li>Worksheets and Templates for Household Systems</li>
